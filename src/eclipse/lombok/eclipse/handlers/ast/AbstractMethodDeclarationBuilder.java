...
abstract class AbstractMethodDeclarationBuilder<SELF_TYPE extends AbstractMethodDeclarationBuilder<SELF_TYPE, NODE_TYPE>, NODE_TYPE extends AbstractMethodDeclaration> implements ASTNodeBuilder<NODE_TYPE> {
	...
	public SELF_TYPE withArgument(StatementBuilder<? extends Argument> argument) {
		this.arguments.add(argument);
		return self();
	}
	
	public SELF_TYPE withArguments(List<StatementBuilder<? extends Argument>> arguments) {
		this.arguments.addAll(arguments);
		return self();
	}
	
	public SELF_TYPE withArguments(Argument... arguments) {
	...
	public SELF_TYPE withStatement(StatementBuilder<? extends Statement> statement) {
		this.statements.add(statement);
		return self();
	}
	
	public SELF_TYPE withStatements(Statement... statements) {
